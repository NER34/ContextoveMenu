...
link:https://github.com/NER34/RightClickContextMenu/blob/master/context_calculator/instructions.json[instructions.json]

link:https://github.com/NER34/RightClickContextMenu/blob/master/context_calculator/context_calculator.js[context_calculator.js]
