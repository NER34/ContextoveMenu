...
image::tlacitko_kontextoveho_menu_1.png[]
...
Pokud do callbacku se neposílají žadné parammetry, mmůžeme nepsát nic v závorkach.
...
image::tlacitko_kontextoveho_menu_2.png[]
...
image::vstupni_pole_kontextoveho_menu_2.png[]
...
image::separator_kontextoveho_menu_2.png[]
